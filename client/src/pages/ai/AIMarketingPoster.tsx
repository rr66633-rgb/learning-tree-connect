...
const templates = [
  ...
  { value: "national_day", label: "اليوم الوطني", emoji: "🇸🇦" },
  { value: "founding_day", label: "يوم التأسيس", emoji: "🏛️" },
  { value: "ramadan", label: "رمضان", emoji: "🌙" },
  { value: "eid", label: "العيد", emoji: "🎉" },
  { value: "graduation", label: "التخرج", emoji: "🎓" },
  { value: "sports_day", label: "اليوم الرياضي", emoji: "⚽" },
  { value: "science_day", label: "يوم العلوم", emoji: "🔬" },
  { value: "family_day", label: "يوم الأسرة", emoji: "👨‍👩‍👧‍👦" },
  { value: "water_fun", label: "اليوم المائي", emoji: "💦" },
  { value: "open_house", label: "يوم مفتوح", emoji: "🏫" },
  { value: "parent_workshop", label: "ورشة أولياء الأمور", emoji: "📋" },
  { value: "summer_program", label: "البرنامج الصيفي", emoji: "☀️" },
  { value: "registration", label: "حملة التسجيل", emoji: "📝" },
];
  ...
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto" dir="rtl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">مصمم البوسترات</h1>
          <p className="text-sm text-gray-500">أنشئ بوسترات احترافية بالذكاء الاصطناعي</p>
        </div>
      </div>
        ...
        <Card>
          <CardContent className="p-5 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input placeholder="مثال: اليوم الرياضي السنوي" value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} />
            </div>
            ...
            <Button onClick={handleGenerate} disabled={generateMutation.isPending} className="w-full bg-purple-600 hover:bg-purple-700">
              {generateMutation.isPending ? <><Loader2 className="h-4 w-4 animate-spin ml-2" />جاري التصميم (10-20 ثانية)...</> : <><Sparkles className="h-4 w-4 ml-2" />تصميم البوستر</>}
            </Button>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-5">
            {posterUrl ? (
              ...
              <div className="flex flex-col items-center justify-center h-80 text-gray-400">
                ...
                <p className="text-sm">البوستر سيظهر هنا</p>
                <p className="text-xs mt-1">اختر قالب واملأ البيانات ثم اضغط تصميم</p>
              </div>
            )}
          </CardContent>
        </Card>
