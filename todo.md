...
- [x] توسيع أنواع الأنشطة التي ترسل إشعار push لولي الأمر (إفطار، غداء، وجبات، قيلولة، حفاض، لعب، إلخ)
- [x] تفعيل طلب إذن الإشعارات لولي الأمر (كان فقط للموظفين)

## Bug Fix - "في المركز الآن" لا يتحدث عند تغيير الحالة
- [x] عند تغيير حالة الطفل من "خروج" إلى "حاضر"، يجب أن يظهر في قائمة "في المركز الآن"
...
## تحسينات صفحة الهبوط التسويقية
- [x] إضافة نموذج حجز عرض تعريفي مع إرسال إشعار للمالك
...
- [x] إصلاح مشكلة ترميز الخط العربي في PDF الخطة الأسبوعية (إعادة كتابة كاملة باستخدام html2canvas + jsPDF بدلاً من jsPDF المباشر)
