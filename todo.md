...
- [ ] إضافة حقل logoUrl في centerSettings schema وقاعدة البيانات
- [ ] إضافة endpoint رفع الشعار في router
- [ ] إضافة واجهة رفع الشعار في صفحة الإعدادات
- [ ] عرض الشعار في ترويسة فاتورة PDF
